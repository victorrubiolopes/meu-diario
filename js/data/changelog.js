...
const CHANGELOG = [
  { date: '2026-08-29', texto: 'Painel do profissional: o card "Medidas da consulta" também aceita texto colado. Cole a folha da consulta (Peso 88,4 / Cintura 92 / Abdômen 98...) e os campos se preenchem sozinhos. Entende acento, caixa, vírgula decimal e a data em dia/mês/ano. Valor fora do razoável (altura escrita em metros, peso digitado errado) é avisado e NÃO entra, porque peso e altura daqui também atualizam o cadastro do paciente. Como nos outros importadores, preencher não envia: você confere e aperta o botão' },
  { date: '2026-08-29', texto: 'Biblioteca de exercícios: 12 novos. Cardio (bicicleta horizontal e vertical, esteira, elíptico, caminhada) pra aquecimento e volta à calma entrarem no plano em vez de virar texto solto, e 7 de baixa exigência técnica pra quem está saindo do sedentarismo ou poupando o joelho — levantar da cadeira, abdução e extensão de quadril em pé, ponte de glúteo, flexão na parede, remada com elástico e prancha na bancada' },
  ...
  { date: '2026-08-18', texto: 'Ajuste na meta própria: tirada a tapioca do pré-treino (5h30) e o azeite do almoço/janta (difícil de controlar a colher). Almoço e janta agora usam batata inglesa assada com o peso já em porção assada, sem conta de equivalência. Meta recalibrada para 1830 kcal / 170g proteína / 42g gordura para bater com o que o cardápio simplificado realmente entrega' },
  { date: '2026-08-18', texto: 'Nova meta calórica própria disponível em Mais → Minhas Dietas: "Meta própria — disponibilidade energética", calculada a partir do TDEE reconstruído dos seus dados de treino/corrida/peso (em vez do gasto estimado pelo nutricionista). 2210 kcal, 177g de proteína, com as 5 refeições do cardápio atualizadas em porção para bater a meta. Só aparece pro dono do app' },
  { date: '2026-08-18', texto: 'Ficha MFIT: os exercícios de barra livre agora mostram também o peso total (ex: "20/20kg · ~60kg com barra olímpica de 20kg"), pra não ter que somar a barra de cabeça na academia' },
  { date: '2026-08-18', texto: 'Nova ficha de treino pessoal disponível em Mais → Planos de Treino → Treino pré-definido: "MFIT Personal — Quarta / Sexta / Domingo", com as três sessões, as cargas da ficha e os pares combinados (biséries) anotados em cada exercício. Como a ficha do Bronyer, só aparece pro dono do app' },
  ...
  { date: '2026-08-16', texto: 'Treino: a duração agora vem sozinha do cronômetro ao finalizar — não precisa mais digitar. O campo continua lá só se você quiser corrigir, e o tempo aparece na confirmação' },
