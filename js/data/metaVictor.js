...
// hábito já formado), com as porções ajustadas pra fechar os novos macros — sem introduzir
// nada novo além de azeite de oliva no almoço/janta (a comida do Victor tem pouca gordura, e
// dava pra fechar os 71g de gordura só com mais queijo/ovo, mas em quantidade pouco realista).
const META_VICTOR = {
  ...
  baseCalculo: [
    ...
    'Meta pensada pra ser o piso dos dias "fora da linha", não um aperto nos 4 dias que já funcionam: ~0,4-0,5% do peso/semana, faixa que preserva massa magra em déficit (Garthe et al. 2011).',
    'Proteína 1,8-2,2 g/kg (Helms et al. 2014) — 177g bate perto da prescrição do Matheus (172,9g) e da regra do vídeo do Leandro Twin (168g).',
  ],
  ...
  combos: [
    {
      ...
      itens: [
        ...
        // Adições pra fechar a meta sem mexer no resto do dia — carbo rápido pré-treino.
    ...
    },
    {
      ...
      horario: '12:30',
      itens: [
        // Antes 100g+100g (arroz+feijão) — sobe pra 150g+150g.
        { foodName: 'Batata inglesa (vaga do arroz 150g + feijão 150g)', qty: 1, kcal: 306, carbs: 62.4, sugars: 3.6, protein: 11.25, fat: 1.2, satFat: 0.15, transFat: 0, fiber: 13.35, sodium: 18 },
        ...
        // Único item novo no cardápio — fecha a gordura sem inflar proteína/carbo.
        { foodName: 'Azeite de oliva', qty: 1, kcal: 119, carbs: 0, sugars: 0, protein: 0, fat: 13.5, satFat: 1.9, transFat: 0, fiber: 0, sodium: 0 },
      ],
    },
    {
      nome: 'R4 · Whey (16:00)',
